...
const PlaylistCard = ({
  ...
  const playlist = listPlaylist.find(item => item.items[0].snippet.playlistId === playlistId);
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.totalVideo}>{playlist?.pageInfo.totalResults}</Text>
      <MaterialIcons style={styles.icon} name="playlist-play" size={40} color="white" />
      </View>
